...
In the last 3 weeks we estimated OLS and logit models, created a standardized dataset and split it into training and test sets, then random forest and support vector machines. This week we play with some more estimation techniques and see how they perform.
